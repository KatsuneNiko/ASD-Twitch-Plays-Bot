...
def mock_pyautogui(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("MouseInputs.pyautogui", mock)
    return mock
...
def test_moveMouse(mock_pyautogui):
